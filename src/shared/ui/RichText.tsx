...
const linkClassName =
  "underline decoration-border-subtle underline-offset-2 hover:decoration-text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white";
